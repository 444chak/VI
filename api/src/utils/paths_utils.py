"""Utility functions for processing paths."""
...
def setup_paths(
    ...
    Returns:
        dict: A dictionary where the keys are hexagon identifiers and the values are
        lists of directions from the parent to the child node for each path associated
        with that hexagon.
